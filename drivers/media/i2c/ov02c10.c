...
static const struct reg_sequence sensor_1lane_setting[] = {
	{0x301b, 0xd2},
	{0x3027, 0xe1},
	{0x380c, 0x08},
	{0x380d, 0xe8},
...
static const struct reg_sequence sensor_2lane_setting[] = {
	{0x301b, 0xf0},
	{0x3027, 0xf1},
	{0x380c, 0x04},
	{0x380d, 0x74},
...
static const struct ov02c10_mode supported_modes[] = {
	{
		...
		.lane_settings = sensor_1lane_setting,
		.lane_settings_length = ARRAY_SIZE(sensor_1lane_setting),
	},
	{
		.width = 1928,
		.height = 1092,
		...
		.reg_sequence = sensor_1928x1092_30fps_setting,
		.sequence_length = ARRAY_SIZE(sensor_1928x1092_30fps_setting),
		.lane_settings = sensor_2lane_setting,
		.lane_settings_length = ARRAY_SIZE(sensor_2lane_setting),
	},
};
