...
static void usbio_i2c_uninit(struct i2c_adapter *adap, struct i2c_msg *msg)
{
	...
	usbio_bulk_msg(i2c->client, USBIO_PKTTYPE_I2C, USBIO_I2CCMD_UNINIT, true,
...
static int usbio_i2c_init(struct i2c_adapter *adap, struct i2c_msg *msg)
{
	...
	ret = usbio_bulk_msg(i2c->client, USBIO_PKTTYPE_I2C, USBIO_I2CCMD_INIT, true,
...
static int usbio_i2c_read(struct i2c_adapter *adap, struct i2c_msg *msg)
{
	...
	if (msg->len > rxchunk) {
		...
		do {
			...
			ret = usbio_bulk_msg(i2c->client, USBIO_PKTTYPE_I2C,
	...
	ret = usbio_bulk_msg(i2c->client, USBIO_PKTTYPE_I2C, USBIO_I2CCMD_READ, true,
...
static int usbio_i2c_write(struct i2c_adapter *adap, struct i2c_msg *msg)
{
	...
	ret = usbio_bulk_msg(i2c->client, USBIO_PKTTYPE_I2C, USBIO_I2CCMD_WRITE, true,
		...
		const struct auxiliary_device_id *adev_id)
{
	...
	usbio_acpi_bind(i2c->client, usbio_i2c_acpi_hids);
	usbio_get_txrxbuf_len(i2c->client, &i2c->txbuf_len, &i2c->rxbuf_len);
