...
void atomisp_assert_recovery_work(struct work_struct *work)
{
	...
	/* stream off sensor */
	ret = v4l2_subdev_call(isp->inputs[isp->asd.input_curr].csi_remote_source, video, s_stream, 0);
	if (ret)
	...
	ret = v4l2_subdev_call(isp->inputs[isp->asd.input_curr].csi_remote_source, video, s_stream, 1);
	if (ret)
