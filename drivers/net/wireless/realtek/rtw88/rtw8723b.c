...
#include "phy.h"
/*
 * The RTL8703B is the same 11n generation as this chip and rtw8703b.h already
 * describes the parts they share: the receive PHY status layout, the SDIO
 * aggregation burst fields and a few baseband registers. Reuse it rather than
 * duplicating those definitions here.
 */
#include "rtw8703b.h"
#include "rtw8723b.h"
...
/*
 * These select simple signal quality levels, as does the rf_para pair
 * below. The values are the vendor driver's.
 */
...
/*
 * rtw8723x_coex_cfg_init() is not used here because the vendor sequence for
 * this chip differs: REG_BT_TDMA_TIME is written whole rather than masked, and
 * neither BIT_PO_BT_PTA_PINS nor REG_QUEUE_CTRL is touched.
 */
...
static const struct rtw_chip_ops rtw8723b_ops = {
	 ...
	 * its shutdown function, not needed for SDIO devices.
	 */
	.shutdown		= NULL,
...
const struct rtw_chip_info rtw8723b_hw_spec = {
	...
	.c2h_ra_report_size = 4,	/* rtw88/rtw8723b_fw.bin v41 emits the
					 ...
					 */
	/*
	 * See commit c7706b1173c7 ("wifi: rtw88: Enable data rate fallback
	 * for older chips").
	 */
